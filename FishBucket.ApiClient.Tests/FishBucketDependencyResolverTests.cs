...
public class FishBucketDependencyResolverTests
{
    ...
    public async Task resolve_single()
    {
        ...
        client.Add(new FishBucketFilesResponse
        {
            Id = "root",
            Dependencies = [],
    ...
    private static BucketFile file(string path) => file(path, path);
    private static BucketFile file(string path, string location)
    {
