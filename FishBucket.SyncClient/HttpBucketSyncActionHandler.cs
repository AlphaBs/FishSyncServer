...
public class HttpBucketSyncActionHandler : IBucketSyncActionHandler
{
    ...
    {
        return action.Action is { Type: "Http", Parameters: not null };
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        await using var readStream = await file.OpenReadStream(cancellationToken);
        ...
        var sendTask = _httpClient.SendAsync(reqMessage, cancellationToken);
